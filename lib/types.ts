import type { DeepReadonly } from '@profusion/json-schema-to-typescript-definitions';
...
export type EnvSchemaProperties<
  ...
  Keys extends KeyOf<S['properties']> = KeyOf<S['properties']>,
> = {
...
export const schemaProperties = <
  S extends BaseEnvSchema,
  Ret extends EnvSchemaProperties<S> = EnvSchemaProperties<S>,
>({
  properties,
...
export type EnvSchemaPropertyValue<
  ...
  K extends KeyOf<S['properties']> = KeyOf<S['properties']>,
> = V[K];
...
> = Readonly<
  Partial<{
    [K in KeyOf<S['properties']>]: EnvSchemaParserFn<S, V, K>;
  }>
>;
...
export type EnvSchemaSerializeFn<
  ...
  K extends KeyOf<S['properties']>,
> = (
  value: Exclude<EnvSchemaPropertyValue<S, V, K>, undefined>,
  propertySchema: Readonly<S['properties'][K]>,
  key: K,
  schema: Readonly<S>,
) => string;
...
> = Readonly<
  Partial<{
    [K in KeyOf<S['properties']>]: EnvSchemaSerializeFn<S, V, K>;
  }>
>;
...
export type EnvSchemaPostValidateFn<
  ...
  V extends BaseEnvParsed<S>,
  K extends KeyOf<S['properties']>,
  PV extends EnvSchemaPropertyValue<S, V, K> = EnvSchemaPropertyValue<S, V, K>,
> = (
  value: PV | undefined,
...
> = Readonly<
  Partial<{
    [K in KeyOf<S['properties']>]: EnvSchemaPostValidateFn<S, V, K>;
  }>
>;
...
export type EnvSchemaConvertFn<
  ...
  Ret = any,
> = (
  value: EnvSchemaPropertyValue<S, V, K> | undefined,
  propertySchema: S['properties'][K],
  key: K,
  schema: Readonly<S>,
  allValues: Partial<V>,
...
> = Readonly<
  Partial<{
    [K in KeyOf<S['properties']>]: EnvSchemaConvertFn<S, V, K>;
  }>
>;
